...
public class Movie {
    ...
    public Movie(Integer film_id, Integer rental_duration, Integer length, String title, String description, String release_year, String rating, ArrayList<String> special_features, Double rental_rate, Double replacement_cost){
